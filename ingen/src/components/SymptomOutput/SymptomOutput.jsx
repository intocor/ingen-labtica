    ...
    >
      ...
      <div className="container squaresymp mt-5">
        ...
        <div className="innersquare">
          ...
          <p> The patient is a 18 year old woman, presenting to the emergency room with a sudden onset high fever of 40 Degree Celcius. She is experiencing intense headache located behind the eyes and the temple. The patient is experiencing mild bleeding from her nose, gums, and eyes. The pain behind the eyes worsens with eye movement. The patient is also complaining of severe muscle and joint pain with a rash that spreads from the arms, legs, torso, and back. Sustained nausea and vomiting has been observed for the past 4 days. It is also observed that her lymph nodes in the neck and groin area are swollen.</p>
          <h1> Differential Diagnosis</h1>
          <p>1. <b>Dengue fever</b>: This viral infection is transmitted by mosquitoes and can cause high fever, severe headache (especially behind the eyes), joint and muscle pain, rash, bleeding from the nose and gums, and swollen lymph nodes.</p>
          <p>2. <b>Meningitis</b>: Inflammation of the meninges (protective membranes) surrounding the brain and spinal cord can cause high fever, severe headache (including behind the eyes and temples), sensitivity to light, nausea, vomiting, and neck stiffness. Swollen lymph nodes may also be present. </p>
          <p>3. <b>Viral hemorrhagic fever </b>: This group of viral infections, including diseases such as Ebola or Marburg, can cause high fever, severe headache, bleeding from various sites (nose, gums, eyes), joint and muscle pain, rash, and swollen lymph nodes.</p>
          <p>4. <b>Malaria </b>: A parasitic infection transmitted by mosquitoes, causing recurrent bouts of high fever, headache (including behind the eyes), muscle and joint pain, fatigue, and sometimes rash. Swollen lymph nodes may also be present.</p>
        </div>
